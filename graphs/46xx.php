<?php
	...
	$query = "SELECT code, name FROM accounts WHERE code BETWEEN 4600 AND 4699";
...
WHERE accounts.code BETWEEN 4600 AND 4699
GROUP BY 1
SQL_BLOCK;
...
<html>
	<head>
		<title>Cost ditrubition 46xx</title>
